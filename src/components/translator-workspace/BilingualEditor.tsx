          ...
          >
            {isApplyingGlossaryToSource ? (
              ...
              <>
                ...
                Áp dụng từ điển
                {glossaryLength > 0 && (
                  <span className="ml-1 bg-amber-900/50 border border-amber-800/40 text-amber-300 text-[9px] font-extrabold px-1.5 py-0.5 rounded-full">
                    {glossaryLength}
                  </span>
                )}
              </>
      ...
      <div className="space-y-4 bg-[#0f1524] border border-slate-800/80 p-5 rounded-2xl shadow-xl flex flex-col justify-between animate-fadeIn">
                      ...
                      <div className="bg-emerald-950/20 border border-emerald-900/40 text-emerald-200 p-3.5 rounded-xl space-y-1.5 animate-slideUp">
                        ...
                        <div className="flex flex-wrap gap-1.5 max-h-40 overflow-y-auto pt-1 pr-1">
                          {autoDiscoveredTerms.map((item) => (
                            <span
                              key={item.id}
                              className="inline-flex items-center gap-1 bg-[#162520]/50 border border-emerald-900/50 rounded-lg px-2 py-0.5 text-[11px] shadow-sm font-semibold text-emerald-300"
                            ...
                            >
                              ...
                              <span className="text-slate-100 font-bold">{item.vietnamese}</span>
              ...
              <div className="space-y-2 animate-fadeIn">
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${isExtractionEnabled ? 'bg-indigo-600' : 'bg-slate-800'}`}
                  >
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-3 border-t border-slate-800/80">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 bg-[#161f30] hover:bg-[#1a253a] text-slate-300 border border-slate-700 font-bold px-4 py-2.5 rounded-lg transition-colors cursor-pointer text-xs"
